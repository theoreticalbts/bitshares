...
namespace bts { namespace blockchain { namespace detail {
  ...
  { try {
      ...
      if( _feed_price.valid() && _relative_bid_itr.valid() )
      {
      ...
      if( _feed_price.valid() && _short_itr.valid() )
      {
  ...
  { try {
      ...
      */
      if( _feed_price.valid() )
      {
        while( _current_bid && _collateral_itr.valid() )
        {
              ...
              cover_ask.get_price().base_asset_id == _base_id )
          {
              ...
              if( cover_ask.get_price() > *_feed_price )
              {
      ...
      if( _feed_price.valid() && _relative_ask_itr.valid() )
      {
